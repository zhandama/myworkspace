<template lang="html">
	<div :class="{'down':(state===0),'up':(state==1),refresh:(state===2),touch:touching}" @touchstart="touchStart($event)" @touchmove="touchMove($event)" @touchend="touchEnd($event)">
				...
				<div class="loading">
					<div class="loading-container clearfix">
							...
							<div class="loading-time fr">
									<!-- <p class="">下拉刷新</p><p class="">释放刷新</p> --><p class="">正在刷新...</p>
